...
const string strMessageMagic = "Tgr Signed Message:\n";
...
static const int64_t nTargetTimespan = 64 * 60;  // 16 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tgr", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TGR ANON 2018";
        CTransaction txNew;
        txNew.nTime = 1522855359;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7e201082b26c4e5525ef9fc8bb6a81ac8e5cff02caae2e28833c7b7e627c066e"));
        block.print();
